...
public abstract class CawebErpAccessingModel extends CawebAccessingModel  {
  ...
  public PageAct changeIfOfficePresent(final String officeName) {
      ...
      protected void action(Page page, ExecutionEnvironment executionEnvironment) {
        ...
        TableQuery.select("事業者・年度の切替")
                  ...
                  .where(term("事業者名", officeName),
                         term("会計年度", "2024年度")) // TODO: We need to come up with a way to avoid hard code the year for the "next year"
                  .$()
                  .perform(page)
                  .getFirst()
                  .getByText("切替")
  ...
  // TODO: Need to refactor following due to duplicated code
  private BinaryOperator<List<Locator>> normalizerFunctionForOfficeTable() {
