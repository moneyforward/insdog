...
import static jp.co.moneyforward.autotest.framework.cli.CliUtils.createSummaryGeneratingListener;
...
public enum CliITUtils {
  ...
  public static TestExecutionSummary executeTestClass(Class<?>... testClasses) {
    ...
    SummaryGeneratingListener testExecutionListener = createSummaryGeneratingListener();
